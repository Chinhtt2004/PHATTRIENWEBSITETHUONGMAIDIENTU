  ...
  return (
    <div className="flex min-h-screen flex-col bg-background selection:bg-primary/20">
      ...
      <main className="flex-1">
        {/* Premium Hero Banner */}
        <section className="relative overflow-hidden bg-gradient-to-br from-rose-500 via-primary to-primary-hover py-12 lg:py-20">
        ...
        <section className="py-16 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-extrabold mb-3 tracking-tight">KHO VOUCHER</h2>
            ...
            <div className="flex flex-col md:flex-row items-end justify-between gap-6 mb-12">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h2 className="text-3xl md:text-4xl font-extrabold tracking-tighter uppercase">Flash Deals</h2>
                </div>
              ...
              <div className="relative group rounded-[2rem] overflow-hidden min-h-[350px] flex px-10 py-12">
                ...
                <div className="flex flex-col justify-between items-start max-w-sm">
                  <div>
                    ...
                    <p className="text-muted-foreground text-lg leading-relaxed">Nuôi dưỡng làn da căng mọng với trọn bộ dưỡng ẩm HA & Vitamin B5.</p>
                  </div>
