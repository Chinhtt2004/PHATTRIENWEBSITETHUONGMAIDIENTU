  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        {/* Banner */}
        <section className="relative bg-gradient-to-r from-primary/90 to-primary-hover py-12 lg:py-16 text-white overflow-hidden">
          <div className="container mx-auto px-4 relative z-10 text-center">
             <Badge className="mb-4 bg-white/20 text-white border-white/30">Ưu đãi độc quyền</Badge>
             <h1 className="font-serif text-4xl md:text-5xl font-bold mb-4">Mã Giảm Giá & Voucher</h1>
             <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
               Sử dụng các mã ưu đãi dưới đây để nhận được mức giá tốt nhất cho lộ trình chăm sóc da của bạn.
             </p>
          </div>
        ...
        <section className="py-12 lg:py-20">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
               <h2 className="font-serif text-2xl md:text-3xl font-bold">Voucher đang hoạt động</h2>
